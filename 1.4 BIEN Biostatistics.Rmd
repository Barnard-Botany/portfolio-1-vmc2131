...
ttest_result1
#ttest_result1 =
# t.test(x=Breadfruit_WPH_small$scrubbed_species_binomial, y=Breadfruit_WPH_small$trait_value, paired=FALSE, alternative="two.sided")
#ttest_result1
```
...
```{r}
Miami_list<-BIEN_list_county(country = "United States", state="Florida", county="Miami-Dade")
head(Miami_list)
tail(Miami_list)
```
```{r}
Monroe_list<-BIEN_list_county(country = "United States", state="Florida", county="Monroe")
head(Monroe_list)
tail(Monroe_list)
```
```{r}
Broward_list<-BIEN_list_county(country = "United States", state="Florida", county="Broward")
head(Broward_list)
tail(Broward_list)
```